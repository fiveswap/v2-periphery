...
import '.deps/npm/@fiveswap/lib/contracts/libraries/FixedPoint.sol';

import '../libraries/SafeMath.sol';
import '../libraries/FiveswapV2Library.sol';
import '../libraries/FiveswapV2OracleLibrary.sol';
...
contract ExampleSlidingWindowOracle {
    ...
    function update(address tokenA, address tokenB) external {
        ...
        if (timeElapsed > periodSize) {
            (uint price0Cumulative, uint price1Cumulative,) = FiveswapV2OracleLibrary.currentCumulativePrices(pair);
    ...
    function consult(address tokenIn, uint amountIn, address tokenOut) external view returns (uint amountOut) {
        address pair = FiveswapV2Library.pairFor(factory, tokenIn, tokenOut);
        ...
        (uint price0Cumulative, uint price1Cumulative,) = FiveswapV2OracleLibrary.currentCumulativePrices(pair);
        (address token0,) = FiveswapV2Library.sortTokens(tokenIn, tokenOut);
