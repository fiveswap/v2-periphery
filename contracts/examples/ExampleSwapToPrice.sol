...
import '../libraries/FiveswapV2LiquidityMathLibrary.sol';
...
contract ExampleSwapToPrice {
    ...
    IFiveswapV2Router01 public immutable router;
    address public immutable factory;

    constructor(address factory_, IFiveswapV2Router01 router_) public {
        factory = factory_;
        router = router_;
    }
    ...
    function swapToPrice(
        ...
        uint256 amountIn;
        {
            (uint256 reserveA, uint256 reserveB) = FiveswapV2Library.getReserves(factory, tokenA, tokenB);
            (aToB, amountIn) = FiveswapV2LiquidityMathLibrary.computeProfitMaximizingTrade(
